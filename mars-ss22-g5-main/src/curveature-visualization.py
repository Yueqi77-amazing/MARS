...
bezier_patches.refine(4) #refine surface into more patches for more detailed coloring
bezier_patches.visualize_curveature(bezier_patches.CURVEATURE_AVERAGE, bezier_patches.COLOR_MAP_LINEAR)
