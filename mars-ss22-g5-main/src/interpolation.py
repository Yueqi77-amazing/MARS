...
s1 = example_spline.interpolate_cubic(spline.INTERPOLATION_EQUIDISTANT, pts)
s2 = example_spline.interpolate_cubic(spline.INTERPOLATION_CHORDAL, pts)
s3 = example_spline.interpolate_cubic(spline.INTERPOLATION_CENTRIPETAL, pts)
s4 = example_spline.interpolate_cubic(spline.INTERPOLATION_FOLEY, pts)
s1.set_color("#000066")
s2.set_color("#0000aa")
s3.set_color("#6666ff")
s4.set_color("#aaaaff")
p = polyline()
control_p = s1.get_polyline_from_control_points()
control_p.set_color("blue")
p.points = pts
p.set_color("red")
